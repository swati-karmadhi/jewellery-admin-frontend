...
const AddCategoryModal = ({ open, togglePopup, labData }) => {
  ...
  return (
    ...
    >
      <DialogTitle id="form-dialog-title">
        {formikProps.values.id === "" ? "Add" : "Edit"} Category
      </DialogTitle>
      <DialogContent sx={{ pb: 1 }}>
        <form onSubmit={formikProps.handleSubmit}>
          <TextField
            ...
            helperText={
              formikProps.touched.labName && formikProps.errors.labName
            }
            error={Boolean(
              formikProps.errors.labName && formikProps.touched.labName
            )}
            sx={{ mb: 3, mt: 1 }}
          />
