...
const validationSchema = Yup.object().shape({
	detailsGroupId: Yup.string().required("Group name is required!"),
	detailName: Yup.string().required("Details name is required!"),
	image: Yup.mixed()
		.test({
...
const DetailsMasterDetails = ({ open, togglePopup, detailsData }) => {
			...
			<form id="inputDetails" onSubmit={formikProps.handleSubmit}>
				<DialogContent sx={{ pb: 1 }}>
					<Select
						...
						value={productGroup.find((e) => e.value === formikProps.values.detailsGroupId)}
						onChange={(e) => {
